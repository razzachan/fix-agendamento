...
const StatusDropdown: React.FC<StatusDropdownProps> = ({ serviceOrders }) => {
  const statusConfigs = [
    ...
    { status: 'diagnosis_completed', label: 'Diagnóstico Concluído', icon: ClipboardList, bgColor: 'bg-orange-50', textColor: 'text-orange-800' },
    { status: 'awaiting_quote_approval', label: 'Aguardando Aprovação', icon: AlertCircle, bgColor: 'bg-yellow-50', textColor: 'text-yellow-800' },
    { status: 'quote_approved', label: 'Orçamento Aprovado', icon: ClipboardList, bgColor: 'bg-green-50', textColor: 'text-green-800' },
    { status: 'ready_for_delivery', label: 'Pronto para Entrega', icon: Package, bgColor: 'bg-teal-50', textColor: 'text-teal-800' },
    { status: 'delivery_scheduled', label: 'Entrega Agendada', icon: Calendar, bgColor: 'bg-blue-50', textColor: 'text-blue-800' },
    { status: 'collected_for_delivery', label: 'Coletado para Entrega', icon: Package, bgColor: 'bg-green-50', textColor: 'text-green-800' },
    { status: 'on_the_way_to_deliver', label: 'Em Rota de Entrega', icon: Truck, bgColor: 'bg-blue-50', textColor: 'text-blue-800' },
